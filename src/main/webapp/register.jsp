    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <div class="card shadow">
                <div class="card-body">
                    <h3 class="card-title text-center"><fmt:message key="register"/></h3>
                    <form action="register" method="post">
                        ...
                        <button class="btn btn-success w-100"><fmt:message key="register"/></button>
                    </form>
                    <hr>
                    <p class="text-center">
                        Đã có tài khoản? <a href="login"><fmt:message key="login"/></a>
                    </p>
                </div>
            </div>
        </div>
